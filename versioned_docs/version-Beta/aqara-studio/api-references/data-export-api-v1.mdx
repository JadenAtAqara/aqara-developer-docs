...
| --- | --- | --- |
| [Query Device IDs by Pages](./trait-api.mdx#query-device-ids-by-pages) | GetDeviceInfoRequest | GetDeviceInfoResponse |
| [Query All Device IDs](./trait-api.mdx#query-all-device-ids) | GetAllDeviceInfoRequest | GetAllDeviceInfoResponse |
| [Query Device Spec Configuration](./trait-api.mdx#query-device-spec-configuration) | GetDevicesRequest | GetDevicesResponse |
| [Query All Device IDs](./trait-api.mdx#query-all-device-ids) |||
