---
title: "Data Export API v1"
description: "Aqara provides the Data Export API v1, which allows you to access device data from the Studio system and perform secondary development."
keywords: ["Aqara Docs", "Aqara Studio", "API Reference", "Data Export API v1"]
---
# Data Export API v1
