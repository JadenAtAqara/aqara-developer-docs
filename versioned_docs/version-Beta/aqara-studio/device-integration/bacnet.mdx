...
1. In the device tree, select the newly added device, go to the `Point` tab and click the `Add point` button. 

    ![Bacnet Point Page](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Bacnet-PointPage.png)
...
2. In the "Add point" page, click **Discover Points** button, Aqara Studio will begin scanning to discover function points for this device.
    ...
    ![Add points](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Bacnet-AddPoints.png)

3. Select the required points and click the blue "+" button. The newly added points will appear in the **Added Points** list on the right, and will also be displayed under the related device in the device tree on the left.
