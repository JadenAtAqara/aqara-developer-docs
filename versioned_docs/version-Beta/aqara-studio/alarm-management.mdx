...
description: "Introduction to Aqara Studio’s alarm services, including configuration, monitoring, and handling of alarms via the real-time Alarm Center to help maintain smart space security."
keywords: ["Aqara Docs", "Aqara Studio", "Alarm Management"]
---
# Alarm Management
