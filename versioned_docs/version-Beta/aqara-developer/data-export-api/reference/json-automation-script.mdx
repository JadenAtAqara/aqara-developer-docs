---
title: "JSON Automation Script"
description: "This document explains the standard structure and examples of writing JSON automation scripts."
keywords: ["Aqara Docs", "Aqara Developer", "JSON Automation Script"]
---
...
Before you start writing a JSON automation script, please make sure you have obtained the necessary trait information by calling the `GET
<Aqara_Developer_URL>/open/api/v1/automations/capabilities` API. For details, see [List Endpoint Capabilities for Automation](./../get-automation-capabilities.api.mdx).
