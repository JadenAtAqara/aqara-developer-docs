---
title: "JSON 自动化脚本定义"
description: "本文档说明编写 JSON 自动化脚本的规范与示例。"
keywords: ["Aqara 文档", "Aqara Studio", "API 参考", "JSON 自动化脚本定义", "json automation script"]
---
...
在开始编写 JSON 自动化脚本前，请确保您已通过调用 `GET
<Aqara_Developer_URL>/open/api/v1/automations/capabilities` 接口 [查询支持自动化的端点能力列表](./../get-automation-capabilities.api.mdx)。
