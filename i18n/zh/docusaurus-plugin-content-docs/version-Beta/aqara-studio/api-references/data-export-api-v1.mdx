...
| --- | --- | -- |
| [分页查询设备 ID 列表](./trait-api.mdx#分页查询设备-id-列表) | GetDeviceInfoRequest | GetDeviceInfoResponse |
| [全量查询设备 ID 列表](./trait-api.mdx#全量查询设备-id-列表) | GetAllDeviceInfoRequest | GetAllDeviceInfoResponse |
